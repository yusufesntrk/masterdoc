---
name: seo-meta-tags
description: SEO meta tags implementation including title, description, Open Graph, Twitter Cards, and canonical URLs. Use when creating or optimizing page metadata for search engines and social sharing.
---
...
const SEO = ({
  ...
  const siteUrl = "https://leyaltech.de";
  const fullUrl = canonical ? `${siteUrl}${canonical}` : siteUrl;
  const fullTitle = `${title} | LeyalTech`;
...
```html
<meta name="author" content="LeyalTech GmbH" />
<link rel="publisher" href="https://www.linkedin.com/company/leyaltech" />
```
...
<title>Die beste Automatisierungslösung für Recruiting-Agenturen in Deutschland | LeyalTech GmbH</title>

<!-- ✅ RIGHT: Concise -->
<title>Recruiting Automatisierung | LeyalTech</title>
